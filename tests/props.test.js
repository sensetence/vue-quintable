...
describe("Props", () => {
  ...
  describe("dynamicConfig", () => {
    ...
    it("can be set to true", () => {
      const wrapper = createTable({ props: { dynamicConfig: true } });
  ...
  describe("loading", () => {
    ...
    it("can be set to true", () => {
      const wrapper = createTable({ props: { loading: true } });
  ...
  describe("verbose", () => {
    ...
    it("enables DEBUG computed when true", () => {
      ...
      const wrapper = createTable({ props: { verbose: true } });
