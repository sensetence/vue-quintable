<template>
    ...
    <div class="content">
        ...
        <b-button v-b-toggle.code-basic variant="secondary" class="mr-2">Toggle Code for App</b-button>
        <b-button v-b-toggle.code-component variant="secondary">Toggle Code Component</b-button>
...
<script>
    ...
    export default {
        ...
        methods:{
            onComponentEvent(data){
                alert("Component "+data.reference+" on index "+data.index + " has just been"+(data.checked?" checked!":" unchecked!"));
            }
        }
    }
</script>
